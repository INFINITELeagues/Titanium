package com.infiniteleagues.titanium.armour;

import com.infiniteleagues.titanium.titanium;
import com.infiniteleagues.titanium.util.RegistryHandler;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    TITANIUM_INGOT(titanium.MOD_ID + ":titanium", 25, new int[] { 2, 5, 6, 2 }, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F, () -> { return Ingredient.fromItems(RegistryHandler.TITANIUM_INGOT.get()); },0);
